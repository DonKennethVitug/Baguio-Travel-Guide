...
@Component({
  selector: 'app-tourist-spots-details',
  templateUrl: './tourist-spots-details.component.html',
  styleUrls: ['./tourist-spots-details.component.css']
})
export class TouristSpotsDetailsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const marker = new google.maps.Marker({
      ...
      icon: "assets/img/tourist-spots-marker.png"
    });
  ...
  public async setPlaceDetails(place_id) {
    ...
    for (const i in tourist_spots) {
      if (tourist_spots[i].place_id === place_id) {
        this.place_details = tourist_spots[i];
